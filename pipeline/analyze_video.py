...
#     FRAME_STRIDE = int(fps)   # 1 frame per second
#     frame_idx = 0
...
#     # --------------------------------------------------
#     # 4. FRAME LOOP (INSIDE WINDOW ONLY)
#     # --------------------------------------------------
#     while cap.isOpened():
...
#             print(f"Processed {frame_idx // FRAME_STRIDE} seconds...")
...
#         if not role_assigner.assigned and len(tracked_people) >= 1:
...
#             # Face region = upper 40% of person bbox
...
#         # -------------------------------
#         # PARTICIPANT QUIT CHECK
#         # -------------------------------
#         for pid in role_assigner.role_map:
#             last_seen = participant_last_seen.get(pid, frame_idx)
#             if frame_idx - last_seen > int(15 * fps):
#                 report.mark_discontinued(pid)
...
#     movement_timestamps = movement_manager.get_timestamps()

#     report = ReportBuilder()
#     final_report = report.build(
#         movement_counts=movement_counts,
#         movement_timestamps=movement_timestamps
#     )
